...
const Download = () => {
  return (
        ...
        <Element name="download" className='"g7 relative pb-32 pt-24 max-lg:pb-24 max-md:py-16'>
            <div className='container'>
                <div className='flex items-center'>
                    <div className='mr-6 relative flex-540 max-xl:flex-280 max-lg:flex-256 max-md:flex-100 '>
                    <div className='mb-10'>
              ...
              <ul className='flex flex-wrap items-center gap-6'> 
                    {links.map(({id,url,icon}) => (
                        <li key={id} className='download_tech-link download_tech-link_last-before download_tech-link_last-after'>
                            <a href={url} className='size-22 download_tech-icon_before relative items-center justify-center rounded-half border-2 border-s3 bg-s1 transition-borderColor duration-500'>
    ...
    <ul className='mt-24 flex justify-around max-lg:hidden'>
